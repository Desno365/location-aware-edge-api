...
class EdgeAggregator(ProcessingUnit):
    ...
    def on_data_message_received(self, incoming_message: DataMessage) -> None:
        self.result_container.data_packages_passing_second_link += 1
        self.result_container.total_latency_second_link += incoming_message.latency_acquired
        self.result_container.traffic_per_distance_second_link += (incoming_message.megabytes_of_data * incoming_message.distance_traveled)
    ...
    def on_processing_ended(self, incoming_message: DataMessage, total_processing_time: float) -> None:
        ...
        self.result_container.data_packages_passing_second_processing += 1
        self.result_container.total_latency_second_processing += total_processing_time
