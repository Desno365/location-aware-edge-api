...
class EdgeLocationCentral(EdgeLocation):
    def __init__(
        ...
        super().__init__(
            ...
            number_of_cores=architecture_parameters.NUMBER_OF_CORES_CENTRAL,
            bandwidth_capability=architecture_parameters.BANDWIDTH_CAPABILITY_CENTRAL,
            mean_processing_start_delay=architecture_parameters.MEAN_PROCESSING_START_DELAY_CENTRAL,
            std_processing_start_delay=architecture_parameters.STD_PROCESSING_START_DELAY_CENTRAL,
